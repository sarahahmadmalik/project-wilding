        ...
        <div>
            <div className=' flex flex-col md:flex-row justify-center md:justify-between  gap-y-6 md:gap-y-0 gap-x-3 items-center px-6 max-w-[1300px] mx-auto py-[50px] md:py-[100px]'>
                ...
                <div className='flex flex-col justify-center max-w-full md:max-w-[720px] items-center md:items-start '>
                    <h1 className='Open  leading-[54px] text-[24px] lg:text-[40px] font-bold max-w-ful md:max-w-[598px] text-left'>BRITAIN: A GREEN AND PLEASANT LAND…RIGHT?</h1>
                    ...
                    <div className='flex flex-wrap  items-center justify-center md:justify-start mt-10 gap-x-4 gap-y-8 start-center '>
                        ...
                        <div className='flex gap-x-3  justify-center '>
                            <div className='bg-[#1A401F] self-center rounded-[5px] text-[white] flex justify-center items-center h-[50px] w-[50px]  text-[24px] font-bold '>03</div>
                            <div className='flex flex-col  justify-center '>
                    ...
                    <a href='/registration' className='bg-[#1A401F] mt-6 flex justify-center max-w-[290px] items-center rounded-[66px] py-4 px-8 md:py-3 md:px-8'>
