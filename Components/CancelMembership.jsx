...
function CancelMembershipModal({ visible, onCancel, onConfirm }) {
  ...
  return (
    <Modal
      title="Cancel your Project Wilding Membership"
      visible={visible}
      onCancel={onCancel}
    ...
    >
      ...
      <p className="font-[700] text-[18px] text-center text-red-800 my-2">
        We are sorry to see that you want to cancel your membership.
      </p>
      <p className="font-[400] text-[13px] text-center my-6">
        If you want to go ahead, your membership will be canceled from: 10/1/2023
      </p>
      <Checkbox
        checked={check1}
      ...
      >
        Past Membership data will be deleted
      </Checkbox>
    </Modal>
  );
}
