    ...
    return (
        <div className='bg-[url(/grass.svg)] bg-center bg-cover bg-no-repeat w-full h-[90vh]'>
            <div className=' backdrop-brightness-[37%] flex flex-col justify-center items-center  h-full    w-full'>
                ...
                <h1 className='Open text-[24px] lg:text-[40px] font-bold    '>{heading}</h1>
                <h6 className='Carme text-[12px] lg:text-[18px] font-normal  max-w-[538px] text-center'>
                    {description}                </h6>
                <button className='bg-[#1A401F] mt-6 flex justify-center items-center rounded-[66px]  py-3 px-8'>
