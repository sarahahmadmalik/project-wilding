        ...
        <div className='bg-[#---]'>
            <footer
                    ...
                    <div class="grid-1 grid Open gap-8 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div className='max-w-[390px] w-full'>
                            ...
                            <form className='w-full'>
                                ...
                                <div class="relative rounded-[77px] w-full">

                                    <input type="Email" id="Email" class="block  w-full p-4 pl-2 text-sm text-gray-900 outline-none focus-none border border-gray-300  rounded-lg bg-[#fff]" placeholder="Enter email address" required />
                                    <button type="submit" class="text-white  absolute right-2.5 bottom-2.5 bg-[#1A401F]  font-medium rounded-lg text-sm px-4 py-2">Subscribe</button>
                                </div>
                            </form>
                ...
                <div class=" p-6 flex justify-between items-center text-center ">
                    ...
                    <span>this website is powered entirely by renewable energy</span>
                </div>
            </footer>
        </div>
    )
